...
void RandomGrayscaleGenerator::Generate(int i, int j, int rows, int cols,
...
void RandomColorGenerator::Generate(int i, int j, int rows, int cols,
                                    PixelSpecifier pixel) {
...
void RandomVectorGenerator::Generate(int i, int j, int rows, int cols,
                                     PixelSpecifier pixel) {
...
void RandomDirectionGenerator::Generate(int i, int j, int rows, int cols,
                                        PixelSpecifier pixel) {
...
GeneratorFactoryRegistration<RandomGrayscaleGeneratorBuilder>
    _RandomGrayscaleGeneratorBuilder("RandomGrayscaleGenerator");
GeneratorFactoryRegistration<RandomColorGeneratorBuilder>
    _RandomColorGeneratorBuilder("RandomColorGenerator");
GeneratorFactoryRegistration<RandomVectorGeneratorBuilder>
    _RandomVectorGeneratorBuilder("RandomVectorGenerator");
GeneratorFactoryRegistration<RandomDirectionGeneratorBuilder>
    _RandomDirectionGeneratorBuilder("RandomDirectionGenerator");
} // namespace GeneratorRegistrations
} // namespace binary
} // namespace image
} // namespace graphics