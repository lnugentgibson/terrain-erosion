...
template <typename T> class GeneratorFactoryRegistration {
public:
  GeneratorFactoryRegistration(const char *id) {
    GeneratorFactory::get().Register(
        id, []() { return std::unique_ptr<GeneratorBuilder>(new T()); });
  }
};
...
template <typename T> class FunctorFactoryRegistration {
public:
  FunctorFactoryRegistration(const char *id) {
    FunctorFactory::get().Register(
        id, []() { return std::unique_ptr<FunctorBuilder>(new T()); });
  }
};
...
template <typename T> class TransformerFactoryRegistration {
public:
  TransformerFactoryRegistration(const char *id) {
    TransformerFactory::get().Register(
        id, []() { return std::unique_ptr<TransformerBuilder>(new T()); });
  }
};
...
template <typename T> class AccumulatorFactoryRegistration {
public:
  AccumulatorFactoryRegistration(const char *id) {
    AccumulatorFactory::get().Register(
        id, []() { return std::unique_ptr<AccumulatorBuilder>(new T()); });
  }
};
...
template <typename T> class CombinerFactoryRegistration {
public:
  CombinerFactoryRegistration(const char *id) {
    CombinerFactory::get().Register(
        id, []() { return std::unique_ptr<CombinerBuilder>(new T()); });
  }
};
...
template <typename T> class ColorizerFactoryRegistration {
public:
  ColorizerFactoryRegistration(const char *id) {
    ColorizerFactory::get().Register(
        id, []() { return std::unique_ptr<ColorizerBuilder>(new T()); });
  }
};
